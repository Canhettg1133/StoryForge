...
function loadRuntime({ savedSettings = null } = {}) {
  ...
  const elements = {
    ...
    customProxyKeyCount: { textContent: '', style: {}, dataset: {} },
...
describe('phase10 translator proxy model default', () => {
  it('ships the proxy default model and versioned runtime assets in the translator HTML', () => {
    ...
    expect(html).toContain('src="js/app.js?v=26"');
    expect(html).toContain('src="js/features/ai-studio-scheduler/config.js?v=2"');
    expect(html).toContain('src="js/translation/errors.js?v=14"');
    expect(html).toContain('src="js/gemini/model-rotation.js?v=19"');
    expect(html).toContain('src="js/gemini/api.js?v=21"');
    expect(html).toContain('src="js/translation/local-store.js?v=24"');
    expect(html).toContain('src="js/translation/retry.js?v=22"');
    expect(html).toContain('src="js/translation/engine.js?v=31"');
    ...
    expect(html).toContain('src="js/ui/controls.js?v=24"');
    expect(html).toContain('src="js/features/ai-studio-scheduler/settings-view.js?v=2"');
    expect(html).toContain('src="js/ui/chunk-tracker.js?v=27"');
    expect(html).toContain('src="js/history/history.js?v=17"');
    expect(html).toContain('src="js/local-ai/ollama.js?v=17"');
    expect(html).toContain('src="js/translation/han-audit.js?v=5"');
    ...
    expect(html).toContain('src="js/proxy/proxy-api.js?v=18"');
