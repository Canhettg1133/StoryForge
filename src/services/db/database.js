...
db.version(22).stores({
  ...
  ai_chat_threads: '++id, project_id, updated_at, created_at',
  ai_chat_messages: '++id, project_id, thread_id, created_at, [thread_id+created_at]',
  ai_chat_attachments: '++id, project_id, thread_id, scope, status, file_type, updated_at, created_at, [thread_id+updated_at], [project_id+scope]',
  ai_chat_attachment_chunks: '++id, attachment_id, chunk_index, [attachment_id+chunk_index]',
  ai_chat_message_attachments: '++id, message_id, attachment_id, order_index, [message_id+order_index], [attachment_id+message_id]',
  entity_resolution_candidates: '++id, project_id, chapter_id, revision_id, session_key, entity_kind, resolution_status, normalized_name, identity_key, matched_entity_id, created_at, updated_at',
});
