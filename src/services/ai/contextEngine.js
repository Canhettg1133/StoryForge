...
export async function gatherContext({
  ...
  const currentChapterOutline = currentRaw
    ? {
      ...
      openingState: currentRaw.opening_state || '',
      handoffFromPrevious: currentRaw.handoff_from_previous || '',
      continuityIn: currentRaw.continuity_in || null,
      conflict: currentRaw.conflict || '',
      decisionOrConsequence: currentRaw.decision_or_consequence || '',
      stateChanges: Array.isArray(currentRaw.state_changes) ? currentRaw.state_changes : [],
      endingState: currentRaw.ending_state || '',
      continuityOut: currentRaw.continuity_out || null,
      pacing: currentRaw.pacing || '',
