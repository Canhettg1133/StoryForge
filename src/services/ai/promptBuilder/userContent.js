...
export function buildUserContent(taskType, context = {}, effectiveMacroArcContract = null) {
  ...
  switch (taskType) {
    ...
    case TASK_TYPES.AI_GENERATE_ENTITY: {
      ...
      const schemaMap = {
        character: '{"name":"Tên nhân vật","role":"protagonist|antagonist|supporting|mentor|minor","specific_role":"Vai trò canon cụ thể nếu tác giả yêu cầu; để rỗng nếu không có","specific_role_locked":false,"age":"tuổi/độ tuổi tùy chọn, chỉ điền khi phù hợp thể loại hoặc hữu ích cho giọng thoại","appearance":"Mô tả 2-3 câu","personality":"Mô tả 2-3 câu","personality_tags":"tag1, tag2","flaws":"Điểm yếu/khuyết điểm","goals":"Mục tiêu","current_status":"Character Live Canon lúc khởi đầu; để rỗng nếu không có ràng buộc canon thật","secrets":"Bí mật nếu có","notes":"Vai trò trong cốt truyện"}',
