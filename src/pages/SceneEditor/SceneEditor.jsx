...
const MOBILE_NAV_ITEMS = [
  ...
  { id: 'su-that', label: 'Sự thật', icon: BookKey, needsProject: true, getPath: (projectId) => `/project/${projectId}/su-that` },
  ...
  { id: 'style-importer', label: 'Prompt Doctor', icon: Sparkles, needsProject: true, getPath: (projectId) => `/project/${projectId}/style-importer` },
  { id: 'writing-debug', label: 'Test prompt viết', icon: FileJson, needsProject: true, surface: 'debug', getPath: (projectId) => `/project/${projectId}/writing-debug` },
  { id: 'lab', label: 'Narrative Lab', icon: FlaskConical, needsProject: true, getPath: (projectId) => `/project/${projectId}/lab`, surface: 'lab' },
  { id: 'lab-lite', label: 'Lab Lite', icon: BookOpen, needsProject: true, getPath: (projectId) => `/project/${projectId}/lab-lite`, surface: 'lab-lite' },
  { id: 'corpus-lab', label: 'Corpus Lab', icon: FlaskConical, needsProject: true, getPath: (projectId) => `/project/${projectId}/corpus-lab`, surface: 'lab' },
  { id: 'timeline', label: 'Timeline', icon: Clock, needsProject: true, getPath: (projectId) => `/project/${projectId}/timeline`, comingSoon: true, surface: 'roadmap' },
  { id: 'revision', label: 'Revision & QA', icon: FileSearch, needsProject: true, getPath: (projectId) => `/project/${projectId}/revision`, comingSoon: true, surface: 'roadmap' },
  { id: 'style-lab', label: 'Style Lab', icon: Palette, needsProject: true, getPath: (projectId) => `/project/${projectId}/style-lab`, comingSoon: true, surface: 'roadmap' },
  ...
  { id: 'account-vip', label: 'Tài khoản & VIP', icon: Crown, needsProject: false, getPath: () => '/login' },
