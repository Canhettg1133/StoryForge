...
const TRANSLATOR_CLICK_ACTIONS = Object.freeze({
    ...
    saveTranslatorCustomProxyPreset: () => saveTranslatorCustomProxyPresetFromUi(),
    updateActiveTranslatorCustomProxyPreset: () => updateActiveTranslatorCustomProxyPreset(),
    useTranslatorCustomProxyPreset: element => requestTranslatorCustomProxyPresetSwitch(element),
    confirmTranslatorCustomProxyPresetSwitch: element => confirmTranslatorCustomProxyPresetSwitch(element),
    deleteTranslatorCustomProxyPreset: element => requestDeleteTranslatorCustomProxyPreset(element),
    cancelTranslatorCustomProxyPresetAction: () => cancelTranslatorCustomProxyPresetAction(),
    ...
    openHanFileAudit: () => window.TranslatorHanFileFeature?.open(),
    closeHanFileAudit: () => window.TranslatorHanFileFeature?.close(),
    cancelHanFileAudit: () => window.TranslatorHanFileFeature?.cancel(),
    correctAllHanFileIssues: () => window.TranslatorHanFileFeature?.correctAll(),
    correctOneHanFileIssue: () => window.TranslatorHanFileFeature?.correctOne(),
    selectHanFileIssue: element => window.TranslatorHanFileFeature?.selectIssue(Number(element.dataset.chunkIndex)),
    previousHanFileIssue: () => window.TranslatorHanFileFeature?.previous(),
    nextHanFileIssue: () => window.TranslatorHanFileFeature?.next(),
    downloadHanFileAudit: () => window.TranslatorHanFileFeature?.download(),
    openSourceChapterReader: () => window.TranslatorChapterFeature?.openSource(),
    openPartialChapterReader: () => window.TranslatorChapterFeature?.openPartial(),
    openResultChapterReader: () => window.TranslatorChapterFeature?.openResult(),
    closeChapterReader: () => window.TranslatorChapterFeature?.close(),
    cancelChapterTask: () => window.TranslatorChapterFeature?.cancelChapterTask(),
    refreshChapterReader: () => window.TranslatorChapterFeature?.refresh(),
    toggleChapterToc: () => window.TranslatorChapterFeature?.toggleToc(),
    toggleChapterEditMode: () => window.TranslatorChapterFeature?.toggleEditMode(),
    selectReaderChapter: element => window.TranslatorChapterFeature?.selectChapter(Number(element.dataset.chapterIndex)),
    previousReaderChapter: () => window.TranslatorChapterFeature?.changeReaderChapter(-1),
    nextReaderChapter: () => window.TranslatorChapterFeature?.changeReaderChapter(1),
    previousReaderPage: () => window.TranslatorChapterFeature?.changeReaderPage(-1),
    nextReaderPage: () => window.TranslatorChapterFeature?.changeReaderPage(1),
    removeChapterBoundary: element => window.TranslatorChapterFeature?.removeChapterBoundary(Number(element.dataset.chapterIndex)),
    enableSuggestedChapterBoundary: element => window.TranslatorChapterFeature?.enableSuggestedChapterBoundary(Number(element.dataset.suggestionIndex)),
    findChapterHeading: () => window.TranslatorChapterFeature?.findChapterHeading(),
    addChapterBoundary: element => window.TranslatorChapterFeature?.addChapterBoundary(Number(element.dataset.matchIndex)),
    exportChapterEpub: () => window.TranslatorChapterFeature?.exportEpub(),
    ...
    cancelHanAudit: () => cancelHanAudit(),
    retryHanAuditIssues: () => retryHanAuditIssues(),
    viewHanAuditChunk: element => viewHanAuditChunk(Number(element.dataset.chunkIndex)),
    retryHanAuditChunk: element => retryHanAuditChunk(Number(element.dataset.chunkIndex)),
...
const TRANSLATOR_CHANGE_ACTIONS = Object.freeze({
    ...
    toggleChapterSuggestions: element => window.TranslatorChapterFeature?.toggleSuggestions(element.checked),
